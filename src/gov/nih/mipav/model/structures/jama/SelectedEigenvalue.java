...
*                              recompile, and try again.
  */
  public void dstebz(char range, char order, int n, double vl, double vu, int il, int iu, double abstol, double d[], double e[],
...
*
*/
  public void dlaebz(int ijob, int nitmax, int n, int mmax, int minp, int nbmin, double abstol,
...
*               array IFAIL.
  */
  public void dstein(int n, double d[], double e[], int m, double w[], int iblock[], int isplit[], double Z[][], 
...
*           < 0:  if info[0] = -i, the i-th argument had an illegal value
  */
  public void dormtr(char side, char uplo, char trans, int m, int n, double A[][],
