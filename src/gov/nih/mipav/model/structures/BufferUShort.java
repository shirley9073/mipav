...
public class BufferUShort extends BufferBase {

    //~ Static fields/initializers -------------------------------------------------------------------------------------

    /** Use serialVersionUID for interoperability. */
    private static final long serialVersionUID = -5218443296426650180L;
     ...
     * @param   position  position in dataArray
     *
     * @return  short value as a double
     */
    protected final double getDouble(int position) {
        return (double) (dataArray[position] & 0xffff);
    }
     ...
     * @param   position  position in dataArray
     *
     * @return  short value as a float
     */
    protected final float getFloat(int position) {
        return (float) (dataArray[position] & 0xffff);
    }
