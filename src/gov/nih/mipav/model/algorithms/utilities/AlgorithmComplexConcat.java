...
public class AlgorithmComplexConcat extends AlgorithmBase {
     ...
     */
    public AlgorithmComplexConcat(ModelImage srcImgR, ModelImage srcImgG, ModelImage srcImgB, int dataType, boolean remap, 
     ...
     * * @param performBoundsChecking  flag for performing bounds checking...normally should be set to true unless negative numbers are desired 
     */
    public AlgorithmComplexConcat(ModelImage srcImgR, ModelImage srcImgG, ModelImage srcImgB, ModelImage destImg,
