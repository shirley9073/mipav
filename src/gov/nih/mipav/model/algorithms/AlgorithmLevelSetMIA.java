 ...
 */
public class AlgorithmLevelSetMIA extends AlgorithmBase implements AlgorithmInterface {
     ...
     */
    public AlgorithmLevelSetMIA(ModelImage srcImg, float[] sigmas, int movement, int iter, float deltaT, float epsilon,
    ...
    private void calc2D() {
        ...
        System.out.println("Algo levelset MIA time = " + elapsedTime);
