 ...
 *
*/
public class AlgorithmDemonsMIA extends AlgorithmBase {
	...
	private DemonsRegistrationMIA algorithm;
    ...
    */
	public AlgorithmDemonsMIA(ModelImage srcImg, ModelImage targetImg, 
		...
		if (reg_.equals("diffusion-like")) {
			regType = DemonsRegistrationMIA.DIFFUSION;
			//MipavUtil.displayMessage("regularization: diffusion-likee \n");
		} else {
			regType = DemonsRegistrationMIA.FLUID;
    ...
    */
	public void runAlgorithm() {
		...
		algorithm = new DemonsRegistrationMIA(image, target, 
		...
		try {
			...
			if (output.equals("transformed_image")) {
				...
				destImage[0] = new ModelImage(ModelStorageBase.FLOAT, destExtents,
														JDialogBase.makeImageName(srcImage.getImageName(), "_Demons_MIA_reg"));				
				...
				destImage[0] = new ModelImage(ModelStorageBase.FLOAT, destExtents,
														JDialogBase.makeImageName(srcImage.getImageName(), "_Demons_MIA_vec"));				
			...
			errorCleanUp("DemonsMIA: Out of memory creating hard classification", true);
			...
			errorCleanUp("DemonsMIA: export problem to destImage[]", true);
