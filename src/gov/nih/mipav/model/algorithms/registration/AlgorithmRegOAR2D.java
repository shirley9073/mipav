...
public class AlgorithmRegOAR2D extends AlgorithmBase {
    ...
    public void runAlgorithm() {
        ...
        if (weighted) {
            ...
            if (DOF >= 3) {
                ...
                if ( (weightedRefPixels > subMinFactor) && (weightedInputPixels > subMinFactor) && doSubsample) {
                    simpleWeightRefSub2 = AlgorithmRegOAR2D.subsampleBy2(simpleWeightRef, false);
                    simpleWeightInputSub2 = AlgorithmRegOAR2D.subsampleBy2(simpleWeightInput, false);
                } else {
                ...
                if ( (weightedRefPixelsSub2 > subMinFactor) && (weightedInputPixelsSub2 > subMinFactor) && doSubsample) {
                    simpleWeightRefSub4 = AlgorithmRegOAR2D.subsampleBy2(simpleWeightRefSub2, false);
                    simpleWeightInputSub4 = AlgorithmRegOAR2D.subsampleBy2(simpleWeightInputSub2, false);
                } else {
                ...
                if ( (weightedRefPixelsSub4 > subMinFactor) && (weightedInputPixelsSub4 > subMinFactor) && doSubsample) {
                    simpleWeightRefSub8 = AlgorithmRegOAR2D.subsampleBy2(simpleWeightRefSub4, false);
                    simpleWeightInputSub8 = AlgorithmRegOAR2D.subsampleBy2(simpleWeightInputSub4, false);
        ...
        if (DOF >= 3) {
            ...
            if ( (simpleRef.dataSize > subMinFactor) && (simpleInput.dataSize > subMinFactor) && allowLevel2
                    && doSubsample) {
                simpleRefSub2 = AlgorithmRegOAR2D.subsampleBy2(simpleRef, doColor);
                simpleInputSub2 = AlgorithmRegOAR2D.subsampleBy2(simpleInput, doColor);
                level1Factor = 2.0f;
            } else {
            ...
            if ( (simpleRefSub2.dataSize > subMinFactor) && (simpleInputSub2.dataSize > subMinFactor) && allowLevel4
                    && doSubsample) {
                simpleRefSub4 = AlgorithmRegOAR2D.subsampleBy2(simpleRefSub2, doColor);
                simpleInputSub4 = AlgorithmRegOAR2D.subsampleBy2(simpleInputSub2, doColor);
                level2Factor = 2.0f;
            } else {
            ...
            if ( (simpleRefSub4.dataSize > subMinFactor) && (simpleInputSub4.dataSize > subMinFactor) && allowLevel8
                    && doSubsample) {
                simpleRefSub8 = AlgorithmRegOAR2D.subsampleBy2(simpleRefSub4, doColor);
                simpleInputSub8 = AlgorithmRegOAR2D.subsampleBy2(simpleInputSub4, doColor);
                level4Factor = 2.0f;
    ...
    private void createTerrain() {
        ...
        for (final Vector3f element : AlgorithmRegOAR2D.originalPath) {
    ...
    public Vector<MatrixListItem>[] levelEight(final ModelSimpleImage ref, final ModelSimpleImage input) {
        ...
        for (int i = 0; i < fineNum; i++) {
            if (matrixList[i].cost < threshold) {
                matrixList[i] = new MatrixListItem(powell.getCost(index), powell.getMatrix(index), powell
                        .getPoint(index));
                index++;
            }
