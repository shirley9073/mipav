 ...
 */
public class AlgorithmConstrainedOAR3D extends AlgorithmBase {
     ...
     */
    public AlgorithmConstrainedOAR3D(ModelImage _imageA, ModelImage _imageB, int _costChoice, int _DOF, int _interp,
     ...
     * @param  _numMinima     Number of minima from level 8 to test at level 4
     */
    public AlgorithmConstrainedOAR3D(ModelImage _imageA, ModelImage _imageB, ModelImage _refWeight,
    ...
    private Vector<MatrixListItem>[] levelEight(ModelSimpleImage ref, ModelSimpleImage input) {
        ...
        if (DOF > 6) {
            powell = new AlgorithmConstPowellOpt3D(this, cog, 4, cost, initial, getTolerance(4), maxIter, bracketBound);
        } else {
       ...
       for (int i = 0; i < fineNumX; i++) {
        ...
        maxIter = baseNumIter * 2;
        powell = new AlgorithmConstPowellOpt3D(this, cog, degree, cost, initial, getTolerance(degree), maxIter,
                                               bracketBound);
        powell.setRunningInSeparateThread(runningInSeparateThread);
        powell.setLimits(limits);
