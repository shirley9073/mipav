 ...
 */
public class MouseEventVectorPlotter implements Serializable {

    //~ Static fields/initializers -------------------------------------------------------------------------------------

    /** Use serialVersionUID for interoperability. */
    private static final long serialVersionUID = -6069342266407301187L;
     ...
     */
    public MouseEventVectorPlotter(String name, Transform3D view, boolean first, Object state, int mode) {
        this.name = name;
        this.view = view;
        this.first = first;
        this.state = state;
     ...
     *
     * @throws  IOException             If the matrix being read in by the JDialogMouseRecorder has the incorrect size.
        ...
        for (int i = 0; i < size; i++) {
            ...
            try {
                ...
                if (eventRead instanceof MouseEvent) {
                    ...
                    SceneStatePlotter vec = (SceneStatePlotter) stream.readObject();
                    stateVector.add(vec);
                } else {
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
        ...
        for (int i = 0; i < mouseEvents.size(); i++) {
            ...
            if (mouseEvents.elementAt(i) instanceof MouseEvent) {
                ...
                SceneStatePlotter stateV = (SceneStatePlotter) stateVector.elementAt(i);
