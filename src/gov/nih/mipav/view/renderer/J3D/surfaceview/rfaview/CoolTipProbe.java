...
public class CoolTipProbe {
    ...
    Color3f yellow = new Color3f(Color.lightGray);
    ...
    private TransformGroup coolTipProbe;

    /** CoolTip probe branch group. */
    private BranchGroup coolTipProbeBG;

    /**
     * Indicator is used by the CoolTip probe to switch color between gray and green. Indicator is the green color
     ...
     *
     * @return  TransformGroup the root of the CoolTip probe.
     */
    ...
    protected void init() {
        ...
        coolTipProbe = new TransformGroup();
        coolTipProbe.setCapability(TransformGroup.ALLOW_CHILDREN_READ);
        coolTipProbe.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);

        coolTipProbeBG = new BranchGroup();
        coolTipProbeBG.setCapability(Group.ALLOW_CHILDREN_EXTEND);
        coolTipProbeBG.setCapability(Group.ALLOW_CHILDREN_READ);
        coolTipProbeBG.setCapability(Group.ALLOW_CHILDREN_WRITE);
        coolTipProbeBG.setCapability(Node.ALLOW_PICKABLE_READ);
        coolTipProbeBG.setCapability(Node.ALLOW_PICKABLE_WRITE);
        ...
        coolTipProbe.addChild(switchGroup);
        switchGroup.addChild(coolTipProbeBG);
        ...
        coolTipProbeBG.addChild(coneTipTG);
        ...
        coolTipProbeBG.addChild(cylinderTipTG);
