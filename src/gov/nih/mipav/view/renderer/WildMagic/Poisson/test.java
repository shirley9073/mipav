...
public class test {
	...
	public static int Execute(int argc, String[] argv, int Degree) {
		...
		cmdLineInt Depth = new cmdLineInt(8);
		cmdLineInt SolverDivide = new cmdLineInt(8);
		cmdLineInt IsoDivide = new cmdLineInt(8);
		cmdLineInt Refine = new cmdLineInt(3);
		cmdLineInt KernelDepth = new cmdLineInt();
		cmdLineFloat SamplesPerNode = new cmdLineFloat(1.0f);
	...
	// int main(int argc,String[] argv)
		...
		switch(degree)
		{
			...
			case 4:
				Execute(argc,args, 4);
				System.err.println("Degree = " + 4);
				break;
			case 5:
				Execute(argc,args, 5);
				System.err.println("Degree = " + 5);
				break;
			default:
