...
public class ViewJFrameImage extends ViewJFrameBase implements KeyListener, MouseListener, MouseMotionListener,
    ...
    public void actionPerformed(final ActionEvent event) {
        ...
        } else if (command.equals("diffDemonsMIA")) {

            if (isMultipleImages() == true) {
                new JDialogDemonsMIA(this, getActiveImage());
            } else {
                MipavUtil.displayError("There are no other images to register.");
            }
        ...
        } else if (command.equals("LevelsetMIA")) {
            new JDialogLevelSetMIA(this, getActiveImage());
        ...
        } else if (command.equals("Transform MIA")) {
            new JDialogScriptableTransformMIA(this, getActiveImage());
