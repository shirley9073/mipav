...
/**
 * @author pandyan
 * This utilty concats multiple 2D images of same type to a 3D image
 *
 */
public class JDialogConcatMult2Dto3D extends JDialogScriptableBase implements
		AlgorithmInterface {
    ...
    /** algorithm **/
    private AlgorithmConcatMult2Dto3D alg;
	 ...
	 *
	 */
	public JDialogConcatMult2Dto3D() {
	 ...
	 * @param im
	 */
	public JDialogConcatMult2Dto3D(Frame theParentFrame, ArrayList<ModelImage> imagesToConcat) {
	...
	private void init() {
        ...
        setTitle("Concat Multiple 2D Images to 3D");
	...
	public void algorithmPerformed(AlgorithmBase algorithm) {
		if(algorithm instanceof AlgorithmConcatMult2Dto3D) {
