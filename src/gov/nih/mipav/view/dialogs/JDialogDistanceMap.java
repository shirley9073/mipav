 ...
 */
public class JDialogDistanceMap extends JDialogScriptableBase 
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("Creates a distance map for the image.");
            }
            ...
            public String getShortLabel() {
                return new String("DistanceMap");
            }

            public String getLabel() {
                return new String("Distance Map");
            }
