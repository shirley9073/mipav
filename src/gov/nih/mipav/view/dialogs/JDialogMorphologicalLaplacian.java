 ...
 */
public class JDialogMorphologicalLaplacian extends JDialogScriptableBase 
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getDescription() {
                return new String("(dilation of image - image) - (image - erosion of image)");
            }
            ...
            public String getShortLabel() {
                return new String("MorphologicalLaplacian");
            }

            public String getLabel() {
                return new String("Morphological Laplacian");
            }
