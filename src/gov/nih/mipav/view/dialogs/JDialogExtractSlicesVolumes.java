...
/**
 * Creates the dialog to remove separate slices in an image. Dialog asks which slices the user wishes to remove; note that
 * in 4D since the slices are removed for a constant z value but different time values no volumes are removed. it
