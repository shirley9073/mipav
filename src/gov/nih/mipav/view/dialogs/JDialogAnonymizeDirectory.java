...
/**
 * Visual Interface to anonymize DICOM images by the directory-full. Multiple directories may be chosen to operate on;
...
public class JDialogAnonymizeDirectory extends JDialogBase {
    ...
    public class AnonymizeDicomDirectories extends Thread {
        ...
        /** DOCUMENT ME! */
        private JDialogAnonymizeDirectory anonDialog; // for notification of completion
        ...
        private boolean anonymizeImage(File imageFile, File destinationDirectory, int[] randomSuffixList,
            ...
            try {
                ...
                if (mi != null) {
                    ...
                    return true;
                } else { // not a dicom file.  leave it.
                    writeToLog(" -- Not a DICOM file.  File not Touched. Model Image = null.", true);
