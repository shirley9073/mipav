...
*
*/  
public class JDialogDemonsMIA extends JDialogScriptableBase 
	implements AlgorithmInterface, ActionDiscovery, LegacyDialogDefaultsInterface  {
    
    private     AlgorithmDemonsMIA 	algo = null;
    ...
    */
    public JDialogDemonsMIA(Frame theParentFrame, ModelImage im) {
    ...
    *	@param im	Source image.
    */
    public JDialogDemonsMIA(ViewUserInterface UI, ModelImage im) {
        super();
    	userInterface = UI;
		if (im.getType() == ModelImage.BOOLEAN || im.isColorImage()) {
            MipavUtil.displayError("Source Image must NOT be Boolean or Color"); 
    ...
    */
    public void algorithmPerformed(AlgorithmBase algorithm) {
		...
		if ( algorithm instanceof AlgorithmDemonsMIA) {
            image.clearMask();
			resultImage = ((AlgorithmDemonsMIA)algorithm).getResultImages();
    ...
    */
    protected void callAlgorithm() {
        ...
        try {
			// Create algorithm
			algo = new AlgorithmDemonsMIA(image, targetImage, 
										levels, iter,
										smoothing, scale,
										regType,
										outputType);
    ...
    public ActionMetadata getActionMetadata() {
        return new MipavActionMetadata() {
            ...
            public String getShortLabel() {
                return new String("DemonsMIA");
            }

            public String getLabel() {
                return new String("Demons MIA");
            }
