...
import niaid.tumorSim.privateSrc.simParams.PlugInDialogSimulateParams544d;
...
public class PlugInSimulateParams544d implements PlugInGeneric {
     ...
     */
    public void run() {
        new PlugInDialogSimulateParams544d(false);
