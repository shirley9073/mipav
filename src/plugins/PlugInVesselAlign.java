...
import ninds.vessel.PlugInDialogVesselAlign;
...
public class PlugInVesselAlign implements PlugInAlgorithm {
    ...
    public void run(Frame parentFrame, ModelImage image) {
        ...
        if (parentFrame instanceof ViewJFrameImage) {
            new PlugInDialogVesselAlign(parentFrame, image);
        } else {
            MipavUtil.displayError("PlugInVesselAlign only runs on an image frame.");
        }
    }
}
