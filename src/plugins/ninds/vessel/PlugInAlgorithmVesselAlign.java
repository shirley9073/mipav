...
import ninds.vessel.PlugInDialogVesselAlign.Interp;
...
public class PlugInAlgorithmVesselAlign extends AlgorithmBase {

    /** Type of interpolation to perform between non-contiguous pieces of VOI */
	private Interp interpType;
     ...
     */
    public PlugInAlgorithmVesselAlign(ModelImage resultImage, ModelImage srcImg) {
        super(resultImage, srcImg);
    }
        
//  ~ Methods --------------------------------------------------------------------------------------------------------

	public void setInterpType(Interp interpType) {
	...
	//  ~ Methods --------------------------------------------------------------------------------------------------------
	    ...
	    private void calc3D() {
	    	...
	    	fireProgressStateChanged("Performing "+interpType.toString().toLowerCase()+" interpolation...");
	    	
	    	/*if(doGaussian) {
	    		System.out.println("Produce image");
	    	...
	    	for(int i=1; i<100000; i++) {
	    		fireProgressStateChanged(String.valueOf(i/1000.0));
            }
        }
