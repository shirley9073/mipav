 ...
 *
 *           <p>$Logfile: /mipav/src/plugins/PlugInDialogFociStrandMesh.java $ $Revision: 21 $ $Date: 1/25/06 4:59p $
 *           </p>
 */
public class PlugInDialogFociStrandMesh extends JDialogScriptableBase implements AlgorithmInterface {
    ...
    /** DOCUMENT ME! */
    private PlugInAlgorithmFociStrandMesh fociStrandMeshAlgo = null;
     ...
     */
    public PlugInDialogFociStrandMesh() { }
     ...
     */
    public PlugInDialogFociStrandMesh(Frame theParentFrame, ModelImage im) {
    ...
    public void algorithmPerformed(AlgorithmBase algorithm) {
        ...
        if (algorithm instanceof PlugInAlgorithmFociStrandMesh) {
            image.clearMask();
    ...
    protected void callAlgorithm() {
        ...
        try {
            ...
            fociStrandMeshAlgo = new PlugInAlgorithmFociStrandMesh(image, redMin, redFraction, greenFraction,
                                                                   radius);
            ...
            // interface
            fociStrandMeshAlgo.addListener(this);
            createProgressBar(image.getImageName(), " ...", fociStrandMeshAlgo);
            ...
            if (isRunInSeparateThread()) {
                ...
                if (fociStrandMeshAlgo.startMethod(Thread.MIN_PRIORITY) == false) {
                    MipavUtil.displayError("A thread is already running on this object");
                }
            } else {
                fociStrandMeshAlgo.run();
            }
        } catch (OutOfMemoryError x) {
            MipavUtil.displayError("PlugInDialogFociStrandMesh: unable to allocate enough memory");
    ...
    private void init() {
        ...
        setTitle("Foci Strand Mesh  10/17/08");
