...
import nibib.spim.PlugInDialogGenerateFusion544c;
...
public class PlugInGenerateFusion544c implements PlugInGeneric {
    ...
    public void run() {
        PlugInDialogGenerateFusion544c test = new PlugInDialogGenerateFusion544c(false);
